...
\begin{problem}
    ...
    \begin{enumerate}[(a)]
		...
		For the first integral in \Cref{prob2c:second}, consider that \(\cos\alpha \cos\beta = \frac{1}{2}[\cos(\alpha + \beta) + \cos(\alpha - \beta)]\). Then,
		\begin{align}
		...
		For the second integral in \Cref{prob2c:second}, consider that \(\sin\alpha \sin\beta = \frac{1}{2}[\cos(\alpha + \beta) - \cos(\alpha - \beta)]\). Then,
		\begin{align}
